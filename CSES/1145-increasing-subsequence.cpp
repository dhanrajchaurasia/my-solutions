...
/* ::::::::::::::::::::::::::::::::::::::::::::::::::::::: MOIVATION-TRICKS-TIPS ::::::::::::::::::::::::::::::::::::::::::::::::: 
    ...
    1) RATING IS SHIT, YOU ARE HERE JUST FOR FUN!, RATING MAY DECREASES BUT NOT THE EXPERIENCE.
    2) NEVER SUBMIT A DUMB CODE! YOU DO EVERYTIME REMIND IT!
    3) FIND ALL POSSIBLES (SEE EDGE CASES) SPECIALLY (0 & 1)
    4) IF YOU'RE AT A QUE FOR MORE THAN 20 MIN AND GETTING NOTHING THEN GO FOR NEXT QUE!
    ...
    10) UB GIVES ITR TO THE LAST ELE. WHEREAS LB GIVES ITR TO THE FIRST ELE.
    11) BEST OF LUCK :)

*/

/* ::::::::::::::::::::::::::::::::::::::::::::::::::::::: SOLUTION TO THE PROBLEM ::::::::::::::::::::::::::::::::::::::::::::::::: */
int Stricly_LIS(vector<int> &a)
{
    int n = size(a);
    vector<int> v;
    for (auto &x : a)
    {
        if (v.empty() or v.bk < x)
            v.pb(x);
        else
            *lb(all(v), x) = x;
    }
