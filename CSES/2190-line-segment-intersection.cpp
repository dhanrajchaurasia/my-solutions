...
void solve(){
    ...
    db c1 = cross(a - c, b - c), c2 = cross(a - d, b - d);
    db c3 = cross(c - a, d - a), c4 = cross(c - b, d - b);
    if (c1 * c2 < 0 and c3 * c4 < 0){
        cout << "YES" << endl;
        return;
    }
    if (!c1 and isBetween(c, a, b)){
        cout << "YES" << endl;
        return;
    }
    if (!c2 and isBetween(d, a, b)){
        cout << "YES" << endl;
        return;
    }
    if (!c3 and isBetween(a, c, d)){
        cout << "YES" << endl;
        return;
    }
    if (!c4 and isBetween(b, c, d)){
        cout << "YES" << endl;
        return;
    }
    cout << "NO" << endl;
