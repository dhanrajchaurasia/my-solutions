...
void solve(){
    ...
    function<void(int)> dfs0 = [&](int u){
        vis[u] = 1;
        for (auto &e : adj[u]) if (!vis[e]) dfs0(e);
        order.pb(u);
    };
    function<void(int)> dfs1 = [&](int u){
        vis[u] = 1, p[u] = new_node;
        for (auto &e : radj[u]) if (!vis[e]) dfs1(e);
    };
    ...
    rep(i, 0, k){
        int u, v; cin >> u >> v, --u, --v; u = p[u], v = p[v];
        cout << (ans[u][v] ? "YES" : "NO") << endl;
    }
}
int32_t main(){
#ifdef coderdhanraj
